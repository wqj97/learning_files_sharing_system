                ...
                <div class="col-sm-12">
                  <table id="example1" class="table table-bordered table-striped dataTable" role="grid"
                    ...
                    foreach ($unsolve_file as $row) {
                        $userName = $Db->query("select U_name,U_school from User where U_openid = '$row[F_user_openid]'")[0]["U_name"];
                        echo "
                      <tr role=\"row\" class=\"even\">
                      <td class=\"sorting_1\">$row[F_Id]</td>
...
<script>
  ...
  function agree (Id) {
    ...
    $.get('/admin/File/Agree?file_id=' + Id +'&file_type_code=' + type + '&file_level=' + level, function (data) {
