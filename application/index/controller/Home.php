...
class home
{
    ...
    public function Index()
    {
        ...
        $top_file = Db::query("select F_Id,F_name,(SELECT count(*) from Comment where C_file_Id = F_Id) as 'comment_count',F_download_count,(SELECT count(*) from Collect_record where C_file_Id = F_Id) as 'collect_record',F_view_count,F_ext from File ORDER BY F_download_count LIMIT 0,12");
